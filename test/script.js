...
var _user$project$TaskSim_EffectManager$Manager = function (a) {
	return {ctor: 'Manager', _0: a};
};
var _user$project$TaskSim_EffectManager$init = function (output) {
	return _user$project$TaskSim_EffectManager$Manager(
...
var _user$project$TaskSim_EffectManager$perform = F4(
	function (_p0, transformErr, transform, task) {
			...
			switch (_p3.ctor) {
				case 'PortTask':
					return {
						ctor: '_Tuple3',
						_0: _p6(
							{ctor: '_Tuple2', _0: _p4, _1: _p3._0.data}),
						_1: function () {
							var f = function (json) {
								return A2(
									_user$project$TaskSim_PortTask$map,
							...
							return A3(_elm_lang$core$Dict$insert, _p4, f, _p5);
						}(),
						_2: _p4 + 1
					};
				case 'Succeed':
				...
				default:
					return {
						...
						_0: A3(
							...
							transformErr,
							transform,
							_elm_lang$core$Task$fail(_p3._0)),
						_1: _p5,
						_2: _p4
					};
			}
		...
		var cmd = _p2._0;
		var nextTasks = _p2._1;
		var newId = _p2._2;
		return {
			ctor: '_Tuple2',
			_0: cmd,
			_1: _user$project$TaskSim_EffectManager$Manager(
				{id: newId, tasks: nextTasks, toCmd: _p6})
		};
	});
var _user$project$TaskSim_EffectManager$transformInput = F2(
	function (_p8, _p7) {
		var _p9 = _p8;
		var _p10 = _p7;
		var _p12 = _p10;
		var _p11 = A2(_elm_lang$core$Dict$get, _p9._0, _p10._0.tasks);
		if (_p11.ctor === 'Just') {
			return A4(
...
var _user$project$TaskSim_App$Model = F2(
	function (a, b) {
		return {userModel: a, effectManager: b};
	});
var _user$project$TaskSim_App$NoOp = {ctor: 'NoOp'};
var _user$project$TaskSim_App$Input = function (a) {
	return {ctor: 'Input', _0: a};
};
var _user$project$TaskSim_App$UserMsg = function (a) {
	return {ctor: 'UserMsg', _0: a};
};
var _user$project$TaskSim_App$program = F3(
	function (input, output, _p0) {
		var _p1 = _p0;
		var view$ = function (_p2) {
			var _p3 = _p2;
			return A2(
				_elm_lang$html$Html_App$map,
				_user$project$TaskSim_App$UserMsg,
				_p1.view(_p3.userModel));
		};
			...
			return _elm_lang$core$Platform_Sub$batch(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$TaskSim_App$UserMsg,
						_p1.subscriptions(model.userModel)),
						input(_user$project$TaskSim_App$Input)
					]));
		};
		var updateHelp = F2(
			function (m, model) {
		...
		var init$ = function () {
			...
			return {
				...
				_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$TaskSim_App$UserMsg, cmd)
			};
		}();
...
var _user$project$Main$decode = function (data) {
	var decoder = A2(
		_elm_lang$core$Json_Decode$andThen,
		_elm_lang$core$Json_Decode$int,
		function (i) {
			return (_elm_lang$core$Native_Utils.cmp(i, 0) > -1) ? _elm_lang$core$Json_Decode$succeed(i) : _elm_lang$core$Json_Decode$fail('something is wrong');
		});
	return A2(_elm_lang$core$Json_Decode$decodeValue, decoder, data);
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Main$Click)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$Main$main = {
	main: A3(
		_user$project$TaskSim_App$program,
